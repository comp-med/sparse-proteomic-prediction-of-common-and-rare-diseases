...
setwd("/GWD/appbase/projects/RD-TSci-UKB/Julia_CZS/ukbb_inc_dz_prediction/Explore_1536_Expansion_analyses/00_protein_imputation/bin/") 

## get protein data and metadata
proteomics <-  fread(cmd = "zcat /hpc/restricted/ukb_project_65851_library/analysis_ready/ukb_ppp_1536_and_3072.txt.gz", sep = "\t", data.table = F)
...
## read in data 
cov <- as.data.frame(fread("/hpc/scratch/rdip1/hg_odt/uk_biobank/proteomics/data/processed/ukb_ppp_1536_and_3072_covariate_annotations.txt", sep = "\t"))
