...
#SBATCH --job-name=detection_rate_biom
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
script="$work_dir/06_DetectionRate_biomarkers_pred_consortcases.R"
...
R CMD BATCH --no-save --no-restore "--args ${dz} ${date} ${yrs}" $script $log_dir/update_DR_res_cc_biom_${dz}_${yrs}.Rout
