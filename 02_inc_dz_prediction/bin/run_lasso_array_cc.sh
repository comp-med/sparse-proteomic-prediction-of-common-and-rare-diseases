...
script="$work_dir/01_ML_pipeline_6m_protein_pxinfo_pred_consortcases.R"
...
R CMD BATCH --no-save --no-restore "--args ${dz} ${date} ${yrs}" $script $log_dir/res_cc_${dz}_${yrs}.Rout
