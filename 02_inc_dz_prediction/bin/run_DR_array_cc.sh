...
script="$work_dir/06_DetectionRate_protein_pxinfo_pred_consortcases.R"
...
R CMD BATCH --no-save --no-restore "--args ${dz} ${date} ${yrs}" $script $log_dir/DR_res_cc_${dz}_${yrs}.Rout
