...
script="$work_dir/06_DetectionRate_biomarkers_pred_subc.R"
...
R CMD BATCH --no-save --no-restore "--args ${dz} ${date} ${yrs}" $script $log_dir/update_DR_res_biom_${dz}_${yrs}.Rout
