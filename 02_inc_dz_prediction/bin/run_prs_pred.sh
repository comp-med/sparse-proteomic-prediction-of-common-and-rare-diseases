...
#SBATCH --job-name=prs_prediction
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
script="$work_dir/04_6m_PRS_pxinfo_pred_consortcases.R"
...
R CMD BATCH --no-save --no-restore "--args ${dz} ${date} ${yrs}" $script $log_dir/prs_only_res_cc_${dz}_${yrs}.Rout
