...
script="$work_dir/05_ML_pipeline_6m_biom_pxinfo_pred_consortcases.R"
...
R CMD BATCH --no-save --no-restore "--args ${dz} ${date} ${yrs}" $script $log_dir/res_update_cc_biom_${dz}_${yrs}.Rout
