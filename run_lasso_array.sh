...
# asign directories
work_dir="/GWD/appbase/projects/RD-TSci-UKB/Julia_CZS/ukbb_inc_dz_prediction/Explore_1536_Expansion_analyses/02_inc_dz_prediction/bin"
log_dir="$work_dir/logs"
script="$work_dir/01_ML_pipeline_6m_protein_pxinfo_pred_subc.R"
...
R CMD BATCH --no-save --no-restore "--args ${dz} ${date} ${yrs}" $script $log_dir/res_${dz}_${yrs}.Rout
